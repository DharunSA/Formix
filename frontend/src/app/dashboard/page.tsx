      ...
      <header className="border-b border-border bg-card sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg tracking-tight text-ink">Formix</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                className="w-full border border-border bg-card rounded-lg pl-9 pr-8 py-2 text-sm text-ink focus:outline-none focus:ring-2 focus:ring-ink/20 focus:border-ink"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
            ...
            <div className="flex items-center gap-1 bg-surface rounded-lg p-1 w-fit">
              {(["all", "draft", "published"] as StatusFilter[]).map((s) => (
                <button
                  ...
                  className={clsx(
                    "px-3 py-1.5 rounded-md text-xs font-medium cursor-pointer capitalize transition-colors",
            ...
            <select
              ...
              className="border border-border bg-card rounded-lg px-3 py-2 text-sm text-ink cursor-pointer focus:outline-none focus:ring-2 focus:ring-ink/20 focus:border-ink sm:ml-auto"
            >
